...
int main(void)
{
  ...
  {
    /* USER CODE END WHILE */
	  printf("Main Programe Is Running\n");
	  HAL_Delay(1000);
    /* USER CODE BEGIN 3 */
  }
  /* USER CODE END 3 */
...
## Output screen shots of serial port utility   :
 ...
 <img width="1893" height="1162" alt="image" src="https://github.com/user-attachments/assets/3fbe65b9-5af2-4513-b320-36a734885f96" />

 
 ## Circuit board :
 
 <img width="720" height="1280" alt="image" src="https://github.com/user-attachments/assets/e3d2cfd4-5cc3-4ad4-bb23-b29c64a609f0" />
